...
description: "Lecture 4 \u2014 compute on stored Parquet; MapReduce mental model;\
  \ DuckDB and Polars benchmarks; k-anonymity at query time. Individual run-only Colab;\
  \ assessed code lives in week-2-group Part B."
...
notebook_description: "Pr\xE1ctica individual de la Lecci\xF3n 4. Misma consulta GEIH\
  \ 2024 con MapReduce, pandas, DuckDB y Polars; benchmark y supresi\xF3n k=5 al publicar\
  \ agregados."
...
<div class="lecture-resources">
  <p>
    <a href="/assets/slides/26-udenar-big-data/l4-processing.html" target="_blank">HTML slides</a> &nbsp;|&nbsp; <a href="https://colab.research.google.com/github/cabrerac/cabrerac.github.io/blob/gh-pages/assets/notebooks/26-udenar-big-data/l4-processing.ipynb" target="_blank">Notebook - Individual</a> &nbsp;|&nbsp; <a href="https://colab.research.google.com/github/cabrerac/cabrerac.github.io/blob/gh-pages/assets/notebooks/26-udenar-big-data/week-2-group.ipynb" target="_blank">Notebook - Group</a> &nbsp;|&nbsp; <a href="/teaching/26-udenar-big-data/">Back to course</a>
  </p>
</div>
