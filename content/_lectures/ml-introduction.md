...
{% include_relative content/_snippets/ml/what-is-ml.md %}

{% include_relative content/_snippets/ml/history.md %}

{% include_relative content/_snippets/ml/applications.md %}
