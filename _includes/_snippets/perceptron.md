...
<div class="rows" style="width: 100%; height: 100%">
  <div class = "row"  style="width: 100%; height:100%; display: flex; align-items: center;">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
      ...
      <!-- Big Data (2000-2012) -->
      <rect x="848.5" y="0%" width="148.5" height="100%" fill="rgba(128, 128, 128, 0.2)" stroke="var(--secondary-color)" stroke-width="1"/>
      <text x="922.75" y="5%" text-anchor="middle" style="font-size: 12px; fill: var(--secondary-color);">
        <tspan x="922.75" dy="0">Big Data</tspan>
        <tspan x="922.75" dy="15">(2000-2012)</tspan>
      </text>
      ...
      <!-- 1966 Event - Critical -->
      <line x1="376" y1="50%" x2="376" y2="40%" stroke="var(--secondary-color)" stroke-width="1"/>
      <circle cx="376" cy="40%" r="1" fill="var(--secondary-color)"/>
      <text x="376" y="35%" text-anchor="middle" style="font-size: 12px; fill: var(--critical-color);">
        <tspan x="376" dy="0">ALPAC Report</tspan>
        <tspan x="376" dy="15">(USA, 1966)</tspan>
      </text>
      <!-- 1969 Event - Symbolic -->
      ...
      <!-- 1969 Event - Critical -->
      <line x1="416.5" y1="50%" x2="416.5" y2="65%" stroke="var(--secondary-color)" stroke-width="1"/>
      <circle cx="416.5" cy="65%" r="1" fill="var(--secondary-color)"/>
      <text x="416.5" y="68%" text-anchor="middle" style="font-size: 12px; fill: var(--critical-color);">
      ...
      <!-- 1973 Event - Critical -->
      <line x1="470.5" y1="50%" x2="470.5" y2="35%" stroke="var(--secondary-color)" stroke-width="1"/>
      <circle cx="470.5" cy="35%" r="1" fill="var(--secondary-color)"/>
      <text x="470.5" y="30%" text-anchor="middle" style="font-size: 12px; fill: var(--critical-color);">
    ...
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 50%">
                ...
                <div class="footnote">Dr. Frank Rosenblant and the Mark I - National Museum of the U.S. Navy, Public domain, via Wikimedia Commons.</div>
            </div>
            <div class="column vertical-top text-left" style="width: 50%">
                <p>The perceptron was simulated by <b>Frank Rosenblatt</b> in 1957 on a IBM 704 machine as a model for biological neural networks. The neural network was invented in 1943 by <a href="https://www.cs.cmu.edu/~epxing/Class/10715/reading/McCulloch.and.Pitts.pdf">McCulloch & Pitts</a>.</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            ...
            <div class="column vertical-top text-left" style="width: 50%">
                <p>The perceptron was simulated by <b>Frank Rosenblatt</b> in 1957 on a IBM 704 machine as a model for biological neural networks. The neural network was invented in 1943 by <a href="https://www.cs.cmu.edu/~epxing/Class/10715/reading/McCulloch.and.Pitts.pdf">McCulloch & Pitts</a>.</p>
                <br>
                <p>By 1962 Rosenblantt published the <a href="https://gwern.net/doc/ai/nn/1962-rosenblatt-principlesofneurodynamics.pdf">"Principles of Neurodynamics: Perceptrons and the Theory of Brain Mechanisms"</a>.</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="columns" style="width: 100%">
            ...
            <div class="column vertical-top text-left" style="width: 50%">
                ...
                <ul>
                    ...
                    <li><b>Outout Layer</b>: 8 perceptrons named "response units" or "R-units".</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-right" style="width: 30%">
                <div class="footnote">Biological Brain vs Perceptron - Rosenblatt, F., Public domain, via Wikimedia Commons</div>
            </div>
            <div class="column vertical-middle text-left" style="width: 70%">
                <img src="https://upload.wikimedia.org/wikipedia/commons/0/08/Organization_of_a_biological_brain_and_a_perceptron.png" alt="Biological Brain vs Perceptron" style="max-width: 100%; height: auto;">
            </div>
        </div>
    </div>
</div>
...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 50%">
                <img src="{{ site.url }}/assets/media/diagrams/perceptron.svg" alt="Perceptron Model" style="max-width: 100%; height: auto;">
                <div class="footnote">Perceptron Architecture.</div>
            </div>
            <div class="column vertical-top text-left" style="width: 50%">
                <p>The perceptron was introduced by <b>Frank Rosenblatt</b> in 1957 as a model for biological neural networks.</p>
                <br>
                <p>It consists of:</p>
                <ul>
                    <li><b>Input layer</b>: Receives feature values</li>
                    <li><b>Weights</b>: Connection strengths</li>
                    <li><b>Summation unit</b>: Computes weighted sum</li>
                    <li><b>Activation function</b>: Threshold function</li>
...
<p>Where:</p>
<ul>
    <li>$\mathbf{x}$ is the input feature vector</li>
    <li>$\mathbf{w}$ is the weight vector</li>
    <li>$w_0$ is the bias term</li>
    <li>$f$ is the activation function</li>
    <li>$y$ is the binary output</li>
</ul>
            </div>
        </div>
    </div>
...
$$
<br>
<p>The activation function is the <b>threshold function</b>:</p>
<br>
$$
f(z) = \begin{cases}
1 & \text{if } z \geq 0 \\
...
$$
<br>
<p>This creates a <b>linear decision boundary</b> that separates the input space into two regions.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 50%">
                <img src="{{ site.url }}/assets/media/diagrams/threshold-step.svg" alt="Threshold Function" style="max-width: 100%; height: auto;">
                <div class="footnote">Threshold Activation Function.</div>
            </div>
            <div class="column vertical-top text-left" style="width: 50%">
                <br>
                <p>The threshold function is <b>non-differentiable</b> at $z = 0$.</p>
                <br>
                <p>This means we cannot use gradient-based optimization methods directly.</p>
                <br>
                <p>Instead, we use the <b>perceptron learning algorithm</b>.</p>
                <br>
                <p>The perceptron learning rule is an <b>online learning algorithm</b> that updates weights incrementally.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-top text-left" style="width: 100%">
                <br>
                <p>The perceptron learning algorithm:</p>
                <br>
<pre><code>
Initialize weights w randomly
repeat
    for each training example (x, y)
        Compute prediction: y_pred = f(w^T x + w_0)
        if y_pred ≠ y then
            Update weights: w = w + α(y - y_pred)x
            Update bias: w_0 = w_0 + α(y - y_pred)
...
<ul>
    <li>Only updates weights when there's a misclassification</li>
    <li>Learning rate α controls the step size</li>
...
<ul>
    ...
    <li>$\hat{y}$ is the predicted label</li>
    <li>$\mathbf{x}$ is the input feature vector</li>
</ul>
<br>
<p>The bias update rule:</p>
$$
w_0 \leftarrow w_0 + \alpha(y - \hat{y})
$$
            </div>
        </div>
    </div>
...
<p><b>Intuition:</b></p>
<ul>
    <li>If $y = 1$ and $\hat{y} = 0$: $(y - \hat{y}) = 1$, so weights increase</li>
    <li>If $y = 0$ and $\hat{y} = 1$: $(y - \hat{y}) = -1$, so weights decrease</li>
    <li>If $y = \hat{y}$: $(y - \hat{y}) = 0$, so no update</li>
</ul>
<br>
<p>The perceptron <b>moves the decision boundary</b> in the direction that reduces classification error.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 50%">
                <img src="https://upload.wikimedia.org/wikipedia/commons/2/20/Svm_separating_hyperplanes.png" alt="Linear Decision Boundary" style="max-width: 100%; height: auto;">
                <div class="footnote">Linear Decision Boundary - Cyc, Public domain, via Wikimedia Commons.</div>
            </div>
            <div class="column vertical-top text-left" style="width: 50%">
                <br>
                <p><b>Geometric interpretation:</b></p>
                <br>
                <p>The perceptron learns a <b>linear decision boundary</b>:</p>
                <br>
$$
\mathbf{w}^T\mathbf{x} + w_0 = 0
$$
<br>
<p>This defines a hyperplane that separates the input space into two regions.</p>
<br>
<p>The weight vector $\mathbf{w}$ is <b>normal to the decision boundary</b>.</p>
<br>
<p>The bias $w_0$ determines the <b>distance from the origin</b>.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-top text-left" style="width: 100%">
                <br>
                <p><b>Perceptron Convergence Theorem:</b></p>
                <br>
                <p>If the training data is <b>linearly separable</b>, the perceptron learning algorithm will converge to a solution in a finite number of steps.</p>
                <br>
                <p><b>Key assumptions:</b></p>
                <ul>
                    <li>Data is linearly separable</li>
                    <li>Learning rate is small enough</li>
                    <li>Features are bounded</li>
                </ul>
                <br>
                <p><b>Limitations:</b></p>
                <ul>
                    <li>Only works for linearly separable data</li>
                    <li>May not find the optimal separating hyperplane</li>
                    <li>Does not converge for non-separable data</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-top text-left" style="width: 100%">
                ...
                <br>
                <p>1. Define the <b>margin</b> as the minimum distance from any point to the decision boundary</p>
                <p>2. Show that the weight vector <b>grows</b> with each update</p>
                <p>3. Show that the <b>angle</b> between current and optimal weights decreases</p>
                <p>4. Conclude that convergence occurs in <b>finite steps</b></p>
                <br>
                <p>The number of updates is bounded by $\frac{R^2}{\gamma^2}$, where $R$ is the maximum norm of input vectors and $\gamma$ is the margin.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 50%">
                <img src="https://upload.wikimedia.org/wikipedia/commons/9/9e/XOR_perceptron_network.png" alt="XOR Problem" style="max-width: 100%; height: auto;">
                <div class="footnote">XOR Problem - Cmglee, CC BY-SA 3.0, via Wikimedia Commons.</div>
            </div>
            <div class="column vertical-top text-left" style="width: 50%">
                <br>
                <p><b>XOR Problem:</b></p>
                <br>
                <p>The perceptron cannot learn the XOR function because it's not linearly separable.</p>
                <br>
                <p><b>Other limitations:</b></p>
                <ul>
                    <li>Only binary classification</li>
                    <li>No probabilistic output</li>
                    <li>Threshold function is not differentiable</li>
                    <li>May oscillate for non-separable data</li>
                </ul>
                <br>
                <p>These limitations led to the development of <b>multi-layer perceptrons</b> and other neural network architectures.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 100%">
                <img src="https://upload.wikimedia.org/wikipedia/commons/2/2d/PerceptronOverview.svg" alt="Perceptron Overview" style="max-width: 100%; height: auto;">
                <div class="footnote">Andreas Maier, CC BY 4.0 <https://creativecommons.org/licenses/by/4.0>, via Wikimedia Commons</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-top text-left" style="width: 100%">
                ...
                <br>
                <ul>
                    <li><b>1957:</b> Frank Rosenblatt introduces the perceptron</li>
                    <li><b>1960:</b> Perceptron Convergence Theorem proven</li>
                    <li><b>1969:</b> Minsky and Papert publish "Perceptrons"</li>
                    <li><b>1970s-1980s:</b> "AI Winter" due to limitations</li>
                    <li><b>1980s:</b> Revival with backpropagation</li>
                </ul>
                <br>
                <p><b>Impact on modern AI:</b></p>
                <ul>
                    <li>Foundation for neural network research</li>
                    <li>Introduction of online learning</li>
                    <li>Understanding of linear separability</li>
                    <li>Motivation for multi-layer networks</li>
                </ul>
                <br>
                <p>The perceptron remains a fundamental concept in machine learning and neural network theory.</p>
            </div>
        </div>
    </div>
</div>
