...
\end{cases}
$$
<br>We need to derive the <b>perceptron criterion</b>. We know we are seeking for parameters vector $\mathbf{w}$ such that features in $\mathbf{x_i}$ in class $C_1$:
$$
    ...
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 40%">
                <br>
                <p>The perceptron learning algorithm is similar to the sthocastic gradient descent.</p>
                <br>
            </div>
...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-top text-left" style="width: 70%">
    ...
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            ...
            <div class="column vertical-top text-left" style="width: 50%">
                ...
                <p><a href="https://rodsmith.nz/wp-content/uploads/Minsky-and-Papert-Perceptrons.pdf">(Minsky & Papert, 1969)</a></p>
                <br>
                <p><b>Other limitations:</b></p>
                <ul>
                    <li>Only binary classification</li>
                    <li>No probabilistic output</li>
                    <li>The step function is not differentiable</li>
