...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 50%">
                <p>The RL-based approach <b>did not work</b> as expected in realistic conditions — for a mix of reasons:</p>
                <ul>
            ...
            <div class="column vertical-middle text-center" style="width: 50%">
                <img src="{{ site.url }}/assets/media/images/PLACEHOLDER-rl-negative-results.png" alt="RL experiments — negative results" style="height: 400px">
            </div>
        </div>
    </div>
</div>
