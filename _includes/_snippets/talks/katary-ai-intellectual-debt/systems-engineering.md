...
<div class="rows" style="height: 100%">
    ...
    <div class="row" style="height: 30%">
        <div class="columns" style="width: 100%">
            ...
            <div class="column vertical-middle text-left" style="width: 50%">
                <b>Top-down analysis:</b> Divide and conquer approach
            </div>
        </div>
    </div>
    <div class="row" style="height: 30%">
        <div class="columns" style="width: 100%">
            ...
            <div class="column vertical-middle text-left" style="width: 50%">
                <b>Variant creation:</b> Assessing solution alternatives
            </div>
        </div>
    </div>
    <div class="row" style="height: 30%">
        <div class="columns" style="width: 100%">
            ...
            <div class="column vertical-middle text-left" style="width: 50%">
                <b>Problem solving cycle:</b> Following a methodology
            </div>
        </div>
    </div>
</div>
