...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 50%">
                <p><b>Code Roulette</b>: We assessed the sensitivity of LLMs to prompt changes for code generation <a href="https://arxiv.org/abs/2506.10204" target="_blank" rel="noopener noreferrer">(Paleyes et al., 2026)</a>.</p>
                <br>
                <p>We found that LLMs can solve the task even when the prompt is truncated or obfuscated to the point of being unintelligible <a href="https://arxiv.org/abs/2506.10204" target="_blank" rel="noopener noreferrer">(Sendyka et al., 2025)</a>.</p>
                </p>
            </div>
            <div class="column vertical-middle text-center" style="width: 50%">
