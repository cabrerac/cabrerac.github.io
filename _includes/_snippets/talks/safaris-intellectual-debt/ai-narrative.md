    ...
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 100%">
                <img src="{{ site.url }}/assets/media/images/perception-4.png" alt="Perception" style="height: 500px">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 100%">
                ...
                <br>
                <p>The same structure is taking shape around <b>quantum computing</b>: early narratives mix real progress with expectations to capture investment.</p>
            </div>
        </div>
    </div>
</div>
