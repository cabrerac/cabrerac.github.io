...
```
            ...
            <div class="column vertical-middle text-left" style="width: 50%">
                ...
                <p><b>Data is secondary and hidden behind services' interfaces.</b></p>
            </div>
        </div>
    </div>
</div>
...
<div class="rows" style="height: 100%">
    <div class="row" style="height: 100%">
        <div class="columns" style="width: 100%">
            <div class="column vertical-middle text-left" style="width: 100%">
                <p><b>The Data Dichotomy</b>: “While data-driven systems are about exposing data, service-oriented architectures and object-oriented programming are about hiding data.” <a
                href="https://www.confluent.io/blog/data-dichotomy-rethinking-the-way-we-treat-data-and-services/" target="_blank" rel="noopener noreferrer">(Stopford, 2016).</a> <b>We need to design systems prioritising data!</b></p>
            </div>
        </div>
    </div>
</div>
